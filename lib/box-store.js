...
function getDataPath() {
  ...
  fs.mkdirSync(path.dirname(STORE_PRIMARY), { recursive: true });
  fs.writeFileSync(STORE_PRIMARY, JSON.stringify(fresh, null, 2));
  return STORE_PRIMARY;
}
...
export function createBox({ title, description, bittyUrl, bittyRelativeUrl, bittyId, htmlSha256, payloadSha256, createdBy, lockConfig } = {}) {
