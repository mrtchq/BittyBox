  ...
  return (
    ...
    >
      <div 
        ...
        className="w-full max-w-lg bg-[#0c0517] border border-amber-500/50 rounded-2xl p-6 sm:p-7 shadow-[0_0_50px_rgba(245,158,11,0.25)] relative overflow-hidden animate-in zoom-in-95 duration-200"
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-amber-950/80 border border-amber-400/60 flex items-center justify-center text-amber-300 shadow-[0_0_20px_rgba(245,158,11,0.35)] flex-shrink-0 animate-pulse">
          ...
          <button
            ...
            onClick={onClose}
            className="p-1.5 rounded-lg text-purple-300/70 hover:text-white hover:bg-purple-900/40 transition"
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center justify-end gap-2.5">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-600 via-rose-600 to-rose-700 hover:from-amber-500 hover:to-rose-600 text-white font-cyber text-xs font-bold tracking-wider shadow-[0_0_20px_rgba(244,63,94,0.4)] hover:shadow-[0_0_25px_rgba(244,63,94,0.6)] active:scale-[0.98] transition cursor-pointer"
          >
